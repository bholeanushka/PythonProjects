...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        # setting title
        self.setWindowTitle("The Stone Paper Scissor")
    ...
    def UiComponents(self):
        ...
        self.user.setStyleSheet(
            "border : 2px solid black; background : white; border-image : url(user.png);")
        ...
        self.computer.setStyleSheet(
            "border : 2px solid black; background : white; border-image : url(computer.jpg);")
    ...
    def rock_action(self):
        ...
        self.user.setStyleSheet("border-image : url(stone.png);")
    ...
    def reset_action(self):
        ...
        self.user.setStyleSheet("border-image :url(user.png);")
        self.computer.setStyleSheet("border-image : url(computer.jpg);")
...
window = Window()
window.setStyleSheet("background-color: rgb(216, 226, 220);")
